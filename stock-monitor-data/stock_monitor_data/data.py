...
def ideas(period: str, interval: str):
    ideas = [Stock(ticker_name="VONOY", period=period, interval=interval,
             ...
             Stock(ticker_name="WOLF", period=period, interval=interval,
                   ...
                   """),
             Stock(ticker_name="MXCHF", period=period, interval=interval,
                   expectation=Expectation(price=5, date=datetime(2030, 1, 15, tzinfo=timezone.utc)),
...
def portfolio(period: str, interval: str):
    res = []
    for ticker_name in ["TGNA", "CEG", "SOMA.V", "TM.V", "FTAI", "CRNT", "ATLX", "CBD", "SCHW", "AMKR", "MMK.VI"]:
        buy_date = None
        description = None
        expectation = None
        if ticker_name == "TGNA":
            ...
            expectation = Expectation(price=80, date=datetime(2024, 9, 15, tzinfo=timezone.utc), confidence=0.3)
            ...
            expectation = Expectation(price=10, date=datetime(2025, 6, 15, tzinfo=timezone.utc), confidence=0.5)
            description = r"""The current value of the investments, cash, and real estate can be ballparked between ~\$81.7M-\$90.7M,
                          the book value sits at ~\$42.7M and the market cap is \$34M. Sum-of-the-parts story has been the stable
                          thesis for the better part of a year and a half now and hasn`t worked yet. So, the question begs, will it ever?"""
