...
def rules_graph(stock):
    adx_df = preprocess_dataframe(adx(stock.history).stack()).rename(
        columns={"level_1": "kind", 0: "value"}
    )
    ...
    return ui.form_card(
        ...
        items=[
            ...
            ui.text_s(
                """RSI values of 70 or above indicate that a security is becoming overbought or overvalued.
